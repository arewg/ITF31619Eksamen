/**
 * Modalen er basert og modifisert fra tidligere 
 * obligatorisk oppgave av Are Warlo Gulliksen og 
 * Elise Dalane Mellegård
 */

import React, { useState } from 'react';
import { useHistory } from 'react-router-dom';
import styled from 'styled-components';
import { create } from '../utils/categoryService.js';
...
const AddCategoryModal = ({ modal, close }) => {
  ...
  return modal ? (
    <Modal>
      ...
      <Input onChange={handleNewCategory} />
      <div>
        <DivButtonAndError>
          <CreateCategoryButton disabled={disableState} onClick={handleSubmit}>
            Opprett
